...
//             break;
//         if (!GetMonData(&gPlayerParty[i], MON_DATA_IS_EGG) && CanLearnTeachableMove(species, ITEM_HM05 - ITEM_TM01))
//             return TRUE;
//     }
//     return FALSE;
// }
...
{
    // if (FlagGet(FLAG_BADGE05_GET) == TRUE && CheckBagHasItem(ITEM_HM05, 1) && CanLearnFlashInParty())
